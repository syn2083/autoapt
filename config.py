...
DEF_DEMO_CONF = [{'site_icd_1': {'origin': 'site_icd_1', 'path': 'C:/APTApplication/ICD/site_icd_1', 'speed': 60000,
                            ...
                            'end_phase': '30', 'jobid': []},
                  'site_icd_2': {'origin': 'site_icd_2', 'path': 'C:/APTApplication/ICD/site_icd_2', 'speed': 12500,
                  ...
                  'site_icd_3': {'origin': 'site_icd_3', 'path': 'C:/APTApplication/ICD/site_icd_3', 'speed': 22000,
                  ...
                  'site_icd_4': {'origin': 'site_icd_4', 'path': 'C:/APTApplication/ICD/site_icd_4', 'speed': 6000,
                  ...
                  'site_icd_5': {'origin': 'site_icd_5', 'path': 'C:/APTApplication/ICD/site_icd_5', 'speed': 6000,
                            'piece_or_sheet': 'reprint', 'multi_step': 0, 'site_prefix': 'A00', 'shift1': '',
                            'shift2': '', 'shift3': '', 'proc_phase': '30', 'end_phase': '30', 'jobid': []},
                  'site_icd_6': {'origin': 'site_icd_6', 'path': 'C:/APTApplication/ICD/site_icd_6', 'speed': 6000,
                            'piece_or_sheet': 'reprint', 'multi_step': 0, 'site_prefix': 'A00', 'shift1': '',
                            'shift2': '', 'shift3': '', 'proc_phase': '30', 'end_phase': '30', 'jobid': []},
                  'site_td': {'origin': 'td', 'path': 'C:/APTApplication/ICD/tdinput', 'speed': 17500,
                         'piece_or_sheet': 'piece', 'multi_step': 0, 'site_prefix': 'A40', 'shift1': '',
                         'shift2': '', 'shift3': '', 'proc_phase': '30', 'end_phase': '30', 'jobid': []}},
                 {'SiteDirs': {'JDF': 'C:/APTApplication/Server/Inputs/JDFInput',
                  ...
                  'EnterpriseDirs': {'JDF': 'C:/APTApplication/Server/Inputs/JDFInput',
                               'JIFACK': 'C:/APTApplication/Server/Inputs/JIFAcks',
                               'PROC': 'C:/APTApplication/Server/Outputs/WIP',
                               'REPRINT': 'C:/APTApplication/Server/Outputs/ReprintFiles'},
                  'DemoDirs': {'exit_data': EXIT_DATA, 'jif_data': JIF_DATA}},
                 {'active_targets': ['site_icd_1', 'site_icd_2', 'site_icd_3', 'site_td'],
                  'reprint_pool': ['site_icd_4', 'site_icd_5', 'site_icd_6'],
                  'all_targets': ['site_icd_1', 'site_icd_2', 'site_icd_3', 'site_icd_4', 'site_icd_5', 'site_icd_6', 'site_td']}]
...
DEF_JIF_CONF = [{'JIF': {'temp_name': 'APTDemo', 'jtype': 'Checks, Statements, New Member', 'jnum': '0001, 9000',
                ...
                'OPTS': {'prange': '1000, 1600', 'srange': '1, 3', 'num_jifs': 1}}]
...
def save_default_sys():
    if not os.path.isfile(os.path.join(DEMO_CONF_DIR, 'sys.ini')):
        with open(os.path.join(DEMO_CONF_DIR, 'sys.ini'), 'w') as syscfg:
            ...
            config.set(mode, 'sys_type', 'enterprise')
            config.write(syscfg)
